@AbapCatalog.sqlViewName: 'ZTDA_CDS_MTRTYPE'
@AccessControl.authorizationCheck: #NOT_REQUIRED
@Search.searchable: true
@EndUserText.label: 'Domain fixed value help'

define view ZTDA_I_SH_MATERIAL_TYPE
  as select from DDCDS_CUSTOMER_DOMAIN_VALUE_T( p_domain_name: 'ZTDA_DM_MATERIAL_TYPE' ) as ValueFix
{
      @UI.hidden: true
