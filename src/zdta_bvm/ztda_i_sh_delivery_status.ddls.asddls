@AbapCatalog.sqlViewName: 'ZTDA_CDS_SHDSTAT'
@AccessControl.authorizationCheck: #NOT_REQUIRED
@Search.searchable: true
@EndUserText.label: 'Domain fixed value help'

define view ztda_i_SH_delivery_status
  as select from DDCDS_CUSTOMER_DOMAIN_VALUE_T( p_domain_name: 'ZTDA_DM_DELIVERY_STATUS' ) as ValueFix
{
      @UI.hidden: true
