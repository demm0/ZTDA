@AbapCatalog.sqlViewName: 'ZTDA_CDS_BDTYPE'
@AccessControl.authorizationCheck: #NOT_REQUIRED
@Search.searchable: true
@EndUserText.label: 'Domain fixed value help'

define view ZTDA_I_SH_BODY_TYPE
  as select from DDCDS_CUSTOMER_DOMAIN_VALUE_T( p_domain_name: 'ZTDA_DM_CAR_BODY_TYPE' ) as ValueFix
{
      @UI.hidden: true
